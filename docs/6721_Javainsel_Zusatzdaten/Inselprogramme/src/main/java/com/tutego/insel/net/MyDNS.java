...
public class MyDNS {
  public static void main( String[] args ) throws UnknownHostException {
    ...
    System.out.println( inet.getCanonicalHostName() ); // mail.networkaholics.de
    System.out.println( inet.getHostAddress() );       // 195.190.9.30
    System.out.println( inet.getHostName() );          // www.tutego.com
    System.out.println( inet.toString() );             // www.tutego.com/195.190.9.30
